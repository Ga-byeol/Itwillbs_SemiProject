...
<jsp:include page="../review/basic.jsp"></jsp:include>
	<div id="wrapper">
		<div id="myPageMenu">
			<input type="checkbox" id="myMenuList1"> 
			<label for="myMenuList1">
				<p>예약 내역</p>
				<ul>
					<li>예약조회</li>
				</ul>
			</label>
			<input type="checkbox" id="myMenuList2">
			<label for="myMenuList2">
				<p>활동 내역</p>
				<ul>
					<li>포인트 적립</li>
					<li>Favorite Car</li>
			...
			</label> <input type="checkbox" id="myMenuList3"> <label
				for="myMenuList3">
				<p>회원정보</p>
				<ul>
					<li><a href="./UserInfo.me">회원 정보 조회</a></li>
					<li><a href="./UserInfoDeleteForm.me">회원 탈퇴</a></li>
				</ul>
			</label>
		</div>
    <div class="wrap">
...
<!--           <input type="button" name="save" id="save" value="등록하기" > -->
			   ...
			   <input type="hidden" name="res_num"><br>
           	   ...
           	   <input type="hidden" name="user_id" value="<%=id %>" readonly><br>
