...
public class ReviewDAO {
	...
	public void insertReview(ReviewDTO dto) {
		...
		System.out.println("ReviewDAO 二쇱냼 : " + dto);
		...
		try {
			...
			String sql="insert into review(review_num, user_id, car_num, review_star, review_cont, review_date) values(?,?,?,?,?,?)";
			...
			pstmt.setString(5, dto.getReview_cont());
	...
	public void updateReivew(ReviewDTO dto) {
		...
		try {
			...
			String sql="update review set review_cont=?, review_star=? where review_num=?";
			pstmt= con.prepareStatement(sql);
